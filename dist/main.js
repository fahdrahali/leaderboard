...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_scoreServices_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../modules/scoreServices.js */ \"./modules/scoreServices.js\");\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n\n\n\nconst render = async () => {\n  const container = document.getElementById('score-list');\n  const scores = await (0,_modules_scoreServices_js__WEBPACK_IMPORTED_MODULE_0__.getAllScoresService)()\n    .then((result) => result);\n  scores.result.forEach((el) => {\n    container.innerHTML += `<li>${el.user}: ${el.score}</li>`;\n  });\n};\n\nrender();\n\n//# sourceURL=webpack://leaderboard/./src/index.js?");
